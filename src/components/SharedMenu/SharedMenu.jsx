    ...
    <div className="w-full p-8 sm:w-10/12 md:p-0 mx-auto my-12">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2  items-center">
        {menuItems?.map((item, index) => (
          <div
            key={index}
            className="flex flex-col justify-center items-center  sm:grid sm:grid-cols-12 sm:items-start   md:h-[104px] md:items-center   rounded-lg hover:scale-105 transition-all duration-300 gap-4"
          >
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm text-center sm:text-start">{item?.recipe}</p>
            </div>
          </div>
