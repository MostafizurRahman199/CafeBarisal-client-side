...
// const AllUsers = () => {
//   const { getAllUsers, deleteUser } = ApiComponent();
...
//   if (allUsers?.length === 0 || allUsers === false) {
//     return (
...
// <SectionHeading title1={"---How many??---"} title2={"MANAGE ALL USERS"}></SectionHeading>

//      <div className="w-full  mx-auto  md:max-h-[calc(100vh-50px)]   bg-white shadow-lg rounded-lg p-6 ">
//       {/* Header */}
...
//                     className=" bg-[#D1A054] btn hover:bg-[#a6752b]"
//                   >
                 
//                   <IoIosPeople className="text-xl text-white" />
//                   </button>
//                 </td>
//                 <td className="py-4 px-4 text-center">
//                   <button
